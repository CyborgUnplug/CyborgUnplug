<?php include '../header.php';?>
    ...
    If you forget your new password you'll have to either log into the device using the command line utility <i>ssh</i> or reset it, using the reset button. Visit <a href="https://plugunplug.net/guides">https://plugunplug.net/guides</a> for more.
	</div>
